...
+(NSInteger)getHoursDifference:(NSDate*)DateFirst FromDate:(NSDate*)DateSecond

{

    NSTimeInterval distanceBetweenDates = [DateFirst timeIntervalSinceDate:DateSecond];
...
//    patientID = [userInfo objectForKey:@"user_id"];
//
//    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
//    NSString *documentsDirectory = [paths objectAtIndex:0];
//    NSString *savedImagePath = [documentsDirectory stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.png",patientID]];
//    // UIImage *image = ; // imageView is my image from camera
//    NSData *imageData = UIImagePNGRepresentation(image);
//    [imageData writeToFile:savedImagePath atomically:YES];
//    [historyModel sharedhistoryModel].UserPicName=[NSString stringWithFormat:@"%@.png",patientID];
//    [historyModel sharedhistoryModel].IsImageTaken=1;
//}
